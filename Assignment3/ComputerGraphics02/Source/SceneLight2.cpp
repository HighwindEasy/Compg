...
void SceneLight2::Init()
{
	...
	light[0].spotDirection = (0.f, 0.1f, 0.f);
	...
	meshList[GEO_QUAD] = MeshBuilder::GenerateQuad("quad", Color(0.4, 0.4, 0.4));
	...
	meshList[GEO_CYLINDER] = MeshBuilder::GenerateCylinder("Cylinder", Color(0.3, 0.3, 0.3), 36);
